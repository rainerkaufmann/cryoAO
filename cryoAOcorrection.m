% cryoAOcorrection(mmc,dm,Z2C,TH,Ws,Wa,pri_only,iter,summode,blcorr,savename)
%
% Requirements:
%  - MATLAB code to drive deformable mirror (here: ALPAO SDK)
%  - Micromanager for MATLAB (https://micro-manager.org/Matlab_Configuration)
%
...
function [Zsum,pbest,pall,img_start,img_end] = cryoAOcorrection(mmc,dm,Z2C,TH,Ws,Wa,pri_only,iter,summode,blcorr,savename)
...
a = [0.00 0.00 0.00 0.30 0.30 0.30 0.30 0.30 0.30 0.15 0.30 0.30 0.15 0.15...
...
legend(figh3,'x','y','Location','SouthEast')
xlim(figh3,[0 iter])
figh4 = subplot(4,2,8);
...
saveas(fighm,['AO_Data_' num2str(pri_only) '_pri_Zmodes_only_' num2str(iter) 'iter_' num2str(summode) '_SumMode_' savename '_Zmodes'],'fig')
saveas(fighm,['AO_Data_' num2str(pri_only) '_pri_Zmodes_only_' num2str(iter) 'iter_' num2str(summode) '_SumMode_' savename '_Zmodes'],'png')
...
saveas(gcf,['AO_Data_' num2str(pri_only) '_pri_Zmodes_only_' num2str(iter) 'iter_' num2str(summode) '_SumMode_' savename '_img_start_end'],'fig')
saveas(gcf,['AO_Data_' num2str(pri_only) '_pri_Zmodes_only_' num2str(iter) 'iter_' num2str(summode) '_SumMode_' savename '_img_start_end'],'png')


save(['AO_Data_' num2str(pri_only) '_pri_Zmodes_only_' num2str(iter) 'iter_' num2str(summode) '_SumMode_' savename '.mat'],...
    'pall','pbest','Zsum','img_start','img_end');
